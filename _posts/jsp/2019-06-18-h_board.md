...
public class BoardDao {
	...
	public List<BoardRec> selectList(int startRow, int endRow) throws BoardException {
		...
		try {
			...
			// ####[1] sql 문장 만들기 (insert문)
			String sql = "SELECT A.ARTICLE_ID, A.WRITER_NAME, A.PASSWORD, A.CONTENT " + 
					"FROM (SELECT ROW_NUMBER() OVER(ORDER BY ARTICLE_ID DESC) RNUM, ARTICLE_ID, WRITER_NAME, PASSWORD, CONTENT FROM ARTICLE) A " + 
