...
* 키 설정
    ...
    <br> &nbsp [hadoop@nn01 ~]$ ssh-copy-id hadoop@nn01
    <br> &nbsp [hadoop@nn01 ~]$ ssh-copy-id hadoop@dn02
    <br> 2) [hadoop@dn01 ~]$ ssh-copy-id hadoop@dn01
    <br> &nbsp [hadoop@dn01 ~]$ ssh-copy-id hadoop@nn01
    <br> &nbsp [hadoop@dn01 ~]$ ssh-copy-id hadoop@dn02
    <br> 3) [hadoop@dn02 ~]$ ssh-copy-id hadoop@dn01
    <br> &nbsp [hadoop@dn02 ~]$ ssh-copy-id hadoop@nn01
    <br> &nbsp [hadoop@dn02 ~]$ ssh-copy-id hadoop@dn02

    4. 패스워드없이 이동 가능(나올 때는 exit 또는 logout)
    <br> 1) [hadoop@nn01 ~]$ ssh dn01
    <br> &nbsp [hadoop@nn01 ~]$ ssh dn02
    <br> 2) [hadoop@dn01 ~]$ ssh nn01
    <br> &nbsp [hadoop@dn01 ~]$ ssh dn02
    <br> 3) [hadoop@dn02 ~]$ ssh nn01
    <br> &nbsp [hadoop@dn02 ~]$ ssh dn01
