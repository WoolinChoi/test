...
* 키 설정
    ...
    <br> 2) [hadoop@nn01 ~]$ ssh-copy-id hadoop@nn01
    <br> 3) [hadoop@nn01 ~]$ ssh-copy-id hadoop@dn02
    <br> 4) [hadoop@dn01 ~]$ ssh-copy-id hadoop@dn01
    <br> 5) [hadoop@dn01 ~]$ ssh-copy-id hadoop@nn01
    <br> 6) [hadoop@dn01 ~]$ ssh-copy-id hadoop@dn02
    <br> 7) [hadoop@dn02 ~]$ ssh-copy-id hadoop@dn01
    <br> 8) [hadoop@dn02 ~]$ ssh-copy-id hadoop@nn01
