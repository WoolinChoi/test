...
tags: [java, webfrontend, bootstrap]
comments: false
---
...
<body>  
 <div class="container">  
    ...
    <h4 class="text-primary"> a 태그 사용 </h4>    
      ...
      <div>
        <button type="button" class="btn-block btn btn-primary btn-lg">화면 전체 버튼</button>
        <button type="button" class="btn-block btn btn-info btn-lg">화면 전체 버튼</button>
      </div>
	<hr>
	
	<!-- label은 작은 문구를 줄때 쓰고 alert가 일반 라벨 -->
...
<body>
<div>
        <h2  class="text-primary"> 우리 스타 보기</h2>
...
<body>
 <div class="container">  
	    ...
	    <!-- class에서 form-inline해주면 웹과 모바일에서 봤을때 크기 조절해준다 -->
...
<body>
 <div class="container">  
    ...
    <hr>
          <span class="glyphicon glyphicon-earphone"> </span> 123-4567-8912
    ...
    <hr>   
          <button type="button" class="btn btn-default btn-lg">
            <span class="glyphicon glyphicon-align-center"> </span> 설정 
          </button>
          
          <button type="button" class="btn btn-default">
            <span class="glyphicon glyphicon-align-justify"> </span> 설정 
          </button>    
          
          <button type="button" class="btn btn-default btn-sm">
            <span class="glyphicon glyphicon-align-left"> </span> 설정 
          </button>
          
          <button type="button" class="btn btn-default btn-xs">
            <span class="glyphicon glyphicon-align-right"> </span> 설정 
          </button>
    <hr>
        ...
        <button type="button" class="btn btn-default blue">
            <span class="glyphicon glyphicon-thumbs-up"> </span> 아주좋아요 
        </button> 
   ...
   <hr>
       <button type="button" class="btn btn-lg btn-primary">
          <span class="glyphicon glyphicon-usd"> </span>  3,000 
       </button>
...
<head>
 ...
 /*
		...
		37.486505, 127.020697
 */
 var Y_point = 37.486505; // Y 좌표
 var X_point = 127.020697; // X 좌표
